...
import com.android.layoutinspectorv2.model.LayoutFileData;
import com.android.layoutinspectorv2.model.ViewNode;
import com.android.layoutinspectorv2.model.ViewProperty;
import com.android.tools.adtui.workbench.ToolWindowDefinition;
import com.android.tools.analytics.UsageTracker;
import com.android.tools.idea.editors.layoutInspectorv2.ptable.LITTableCellEditorProvider;
import com.android.tools.idea.editors.layoutInspectorv2.ptable.LITableGroupItem;
import com.android.tools.idea.editors.layoutInspectorv2.ptable.LITableRendererProvider;
...
public class LayoutInspectorContext implements Disposable, DataProvider, ViewNodeActiveDisplay.ViewNodeActiveDisplayListener,
  ...
  public LayoutInspectorContext(@NotNull Project project, @NotNull LayoutFileData layoutParser, @NotNull Disposable parentDisposable) {
    ...
    if (isDumpDisplayListEnabled()) {
      ...
      myDumpDisplayListMenuItem.addActionListener(new DumpDisplayListActionListener());
  ...
  private void createNotification(@NotNull String message, @NotNull NotificationType type) {
    NotificationFixHelper.INSTANCE.createNotification(message, type, project);
  }
